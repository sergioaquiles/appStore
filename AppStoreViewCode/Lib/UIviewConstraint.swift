...
extension UIView {
    ...
    func fillUp(top: NSLayoutYAxisAnchor?, leading: NSLayoutXAxisAnchor?, trailing: NSLayoutXAxisAnchor?, bottom: NSLayoutYAxisAnchor?, padding: UIEdgeInsets = .zero, size: CGSize = .zero) {
    ...
    func fillSuperView(padding: UIEdgeInsets = .zero) {
        ...
        fillUp(top: superview?.topAnchor,
    ...
    func centerSuperView (size: CGSize) {
        translatesAutoresizingMaskIntoConstraints = false
